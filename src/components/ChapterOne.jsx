  ...
  return (
    <div className='ChapterOne'>
      <div className='topbox'>
        ...
        <ul>
          <li>I. Communism is already acknowledged by all European powers to be itself a power.</li>
          <li>II. It is high time that Communists should openly, in the face of the whole world, publish their views, their aims, their tendencies, and meet this nursery tale of the Spectre of Communism with a manifesto of the party itself. </li>
        </ul>
      </div>
      ...
      <div className='content'>
        ...
        <p>The history of all hitherto existing society(2) is the history of class struggles.</p>
